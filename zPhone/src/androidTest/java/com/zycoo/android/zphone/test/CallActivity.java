...
public class CallActivity extends Activity {
    ...
    private TextView mTextView_Status; // 显示是否注册
    ...
    private final static String SIP_DOMAIN = "192.168.1.49";
    private final static String SIP_USERNAME = "804"; // 注册的号码
    private final static String SIP_PASSWORD = "123456";
    private final static String SIP_SERVER_HOST = "192.168.1.49";
    public final static String SIP_REMOTE_PEER = "809"; // 向外拨打的号码
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        if (mAVSession != null && mAVSession.isConnected()) {
                            if (before < count) {
                                ...
                                for (int i = 0; i < len; ++i) {
                                    mAVSession
                                            .sendT140Data(tmedia_t140_data_type_t.tmedia_t140_data_type_backspace);
                                }
                            }
                        }
                    }
        ...
        mButton_Call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mAVSession != null) {
                    ...
                    mAVSession = NgnAVSession.createOutgoingSession(mSipService.getSipStack(),
                            NgnMediaType.AudioT140);
                    mAVSession.makeCall(NgnUriUtils.makeValidSipUri(SIP_REMOTE_PEER));
                    // 809 to sip:809@192.168.1.49
                    Log.d(TAG, "call user: " + NgnUriUtils.makeValidSipUri(SIP_REMOTE_PEER));
                            ...
                            if (NgnStringUtils.equals(args.getContentType(),
                                ...
                                switch (dataType) {
                                    case tmedia_t140_data_type_backspace:
                                        ...
                                        if (length > 0) {
                                            mTextView_History.getEditableText().delete(length - 1,
                                                    length);
                                        }
                                        break;
