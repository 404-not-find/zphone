 ...
 * This takes in charge of cursor callbacks by forwarding to
 * {@link #changeCursor(Cursor)}.<br/>
 * It also takes in charge to retrieve and update progress indicator. Custom
 * views for this must contains :
 * <ul>
 ...
 * @author r3gis3r
 */
public abstract class CSSListFragment extends SherlockListFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        // When we will recycle this view, the stored shown and list containers
        // becomes invalid
        mListShown = false;
        mListContainer = null;
