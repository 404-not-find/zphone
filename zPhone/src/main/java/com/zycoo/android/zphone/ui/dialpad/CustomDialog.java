...
public class CustomDialog
{
    ...
    public static AlertDialog create(Context context, int icon, String title,
        ...
        DialogInterface.OnClickListener negative)
    {
        ...
        ImageView ivIcon =
            (ImageView) layout.findViewById(R.id.custom_dialog_imageView_icon);
        ivIcon.setImageResource(icon);
        TextView tvTitle =
            (TextView) layout.findViewById(R.id.custom_dialog_textView_title);
        tvTitle.setText((title == null) ? "" : title);
        TextView tvMsg =
            (TextView) layout.findViewById(R.id.custom_dialog_textView_msg);
        tvMsg.setText(msg);
