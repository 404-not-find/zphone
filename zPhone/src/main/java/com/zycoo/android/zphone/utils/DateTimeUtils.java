...
public class DateTimeUtils extends NgnDateTimeUtils{
	...
	public static String getTodayName(){
		if(sTodayName == null){
			sTodayName = ZphoneApplication.getAppResources().getString(R.string.day_today);
		}
		return sTodayName;
	}
	...
	public static String getYesterdayName(){
		if(sYesterdayName == null){
			sYesterdayName = ZphoneApplication.getAppResources().getString(R.string.day_yesterday);
		}
