...
public class Persistence extends SQLiteOpenHelper implements BaseColumns {
   ...
   * @param connection The connection to remove_from_call_log from the database
   */
  public void deleteConnection(Connection connection) {
    ...
    db.close();
    //don't care if it failed, means it's not in the db therefore no need to remove_from_call_log
